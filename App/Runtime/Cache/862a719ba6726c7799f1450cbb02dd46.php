	...
	<div class="am-g">
		<div class="col-lg-6 col-md-8 col-sm-centered">
			...
			<form id="myform" method="post"
				...
				<div class="am-form-group" id="playerNameBox">
				<h3>运动员姓名<sup class="am-text-danger">*</sup>：</h3>
				<select id="playerid" name="playerid">
							<?php if(is_array($userList)): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				...
				<div class="am-form-group " id="scoreBox">
					<label class="am-form-label " for="name">成绩<sup class="am-text-danger">*</sup>： <small></small>
					</label> <input type="text" id="score" name="score" placeholder="请填写该运动员成绩"
						class="am-form-field">
				</div>

			</form>
			<div class="am-cf">
				<button id="subCheckIn" class="am-btn am-btn-primary am-btn-block">提交信息</button>
			</div>	
